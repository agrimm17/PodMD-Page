...
const InstallInstructionsContainer = () => {
  ...
  return (
    <>
      <Typography variant='h2' className='sectionTitle' sx={{ color: 'rgb(225,225,225)', fontSize: 30, fontWeight: 700, textAlign: 'center', paddingBottom: 2, paddingTop: 5 }}>Instructions</Typography>
      <Box id='accordionBox'>
