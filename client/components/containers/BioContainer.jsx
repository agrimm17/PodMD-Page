  ...
  return (
    <>
      ...
      >
        <BiosCard
          name='Aaron Jacobs'
          imgPath='client/assets/teamPhotos/aaronJacobs.jpg'
        ...
        <BiosCard
          name='Alex Grimm'
          imgPath='client/assets/teamPhotos/alexGrimm.jpeg'
        ...
        <BiosCard
          name='Mason Meyer'
          imgPath='client/assets/teamPhotos/masonMeyer.jpeg'
        ...
        <BiosCard
          name='RJ McCarthy'
          imgPath='client/assets/teamPhotos/rjMccarthy.jpeg'
        ...
        <BiosCard
          name='Timothy Cheng'
          imgPath='client/assets/teamPhotos/timothyCheng.jpeg'
